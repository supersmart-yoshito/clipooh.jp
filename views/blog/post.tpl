...
<td>
<input type="radio" name="publish" value="0" {if empty($publish)}checked{/if}/>{$lang->convert('全体に公開')}
<input type="radio" name="publish" value="1" {if $publish === 1}checked{/if}/>{$lang->convert('友達に公開')}
<input type="radio" name="publish" value="2" {if $publish === 2}checked{/if}/>{$lang->convert('ブループに公開')}
<input type="radio" name="publish" value="3" {if $publish === 3}checked{/if}/>{$lang->convert('非公開')}
</td></tr>
</table>
