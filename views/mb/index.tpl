{include file="`$smarty.const.TEMPLATE_DIR`/common/header.tpl" pageTitle=$smarty.const.SITE_NAME add_css="slider.css" add_js="image_slider.js,tabs.js,clip_post.js,accordion.js"}
...
{if $user}
  ...
  <li><a href="/monoclip/clip/{$myclip->getId()}">
  ...
  <div class="clip-content">
    <img src="/monoclip/imageapi/{$myclip->image_id}" />
